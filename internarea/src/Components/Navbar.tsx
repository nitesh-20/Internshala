                    ...
                    {showPersonalMenu && (
                      <div className="absolute right-0 mt-3 w-64 rounded-2xl bg-white p-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] ring-1 ring-slate-100 z-50 origin-top-right transform transition-all">
                        ...
                        <button
                          ...
                          className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors disabled:opacity-50"
                        >
                          ...
                          <span>{isGoogleLoggingIn ? "Logging in..." : t("continue_with_google")}</span>
                        </button>
                      </div>
                    )}
                  </div>
            ...
            {!user && (
              <>
                <button
                  ...
                  className="px-4 py-3 text-base font-medium text-slate-700 hover:bg-slate-50 rounded-xl flex items-center gap-3 disabled:opacity-50"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
